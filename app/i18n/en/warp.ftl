...
server-file-browser-menu-upload-file = Upload file here
server-file-browser-menu-upload-folder = Upload folder here
server-file-browser-menu-copy-path = Copy path
server-file-browser-menu-jump-to-path = Jump to this path
