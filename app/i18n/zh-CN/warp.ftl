...
settings-about-automatic-updates-description = 开启后，Zap 会在后台定期检查是否有新版本;发现新版本后会在上方提示并提供 GitHub 下载链接。Zap 不会自动下载或安装更新。
...
server-file-browser-menu-upload-file = 上传文件到此处
server-file-browser-menu-upload-folder = 上传文件夹到此处
server-file-browser-menu-copy-path = 复制路径
server-file-browser-menu-jump-to-path = 跳转到此路径
